        ...
        <div>
            ...
            <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <div class="flex flex-col lg:flex-row justify-between gap-8">
                    ...
                    <div data-aos="zoom-in" class="w-full lg:w-8/12">
                ...
                <div class="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                    ...
                    <div class="w-full lg:w-8/12 lg:pt-8">
                        <div class="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                            <div data-aos="fade-up" class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <div data-aos="fade-down" class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <div data-aos="fade-right" class="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <div data-aos="fade-left" class="p-4 pb-6 flex justify-center flex-col items-center">
